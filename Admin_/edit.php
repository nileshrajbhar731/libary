...
?>
	...
	<div class="profile_info" style="text-align: center;">
		...
		<h4 style="color: white;"><?php echo $_SESSION['login_Admin']; ?></h4>
	</div><br><br>
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admin SET pic='$pic', first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_Admin']."';";
